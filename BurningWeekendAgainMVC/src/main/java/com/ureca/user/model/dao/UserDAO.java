...
//	public List<Person> selectAll();//모든 Person 조회
	...
	public int insert(User user) throws SQLException;// 나는 sql실행만 전념하겠어!!
	 ...
	 * <DAO작성법>
	 * 
	 * public int insert(DTO); public int update(DTO); public int delete(PK);
	 * 
	 * public DTO select(PK);//한행에 대한 상세,수정 public List<DTO> selectAll(); //여러행 조회
	 * 
